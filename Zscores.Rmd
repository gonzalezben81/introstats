...
ggplotthree <- ggplot(df, aes(x, y)) +
  ...
  annotate("text", x = -z_abs - 0.5, y = 0.3, label = paste0(round((1 - prob_one_tail) * 100, 2), "% in left tail"), color = "blue") +
  annotate("text", x = z_abs + 0.5, y = 0.2, label = paste0(round((1 - prob_one_tail) * 100, 2), "% in right tail"), color = "red") +
