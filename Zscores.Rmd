...
What is a z-score you ask? A z-score is a transformed version of a raw score in a data set. This transformation allows us to standardize a mean of `0` and a standard deviation of `1`. Thus, allowing us to more easily see how far above or below the `mean` a raw score is.
